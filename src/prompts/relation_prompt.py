...
/**
 * [IN]: 无直接输入
 * [OUT]: RELATION_PROMPT 常量 - 文献关系推断 Prompt 模板
 * [POS]: 被 summarizer.py 消费，用于生成文献间关系
 * [PROTOCOL]: 修改字段需同步更新 RESEARCH_CONTEXT.md
 */
"""

# 文献关系推断 Prompt
RELATION_PROMPT = """你是一位学术研究专家，擅长分析文献之间的学术关系。
...
def format_papers_for_relation(papers: list[dict]) -> str:
    """
